...
class TP_OCDI_Demo_Importer {
    ...
    public function import_files_config() {
		...
		$home_prevs = array(
			'tp_demo_home1' => array(
				'title' => __( 'Home Default', 'tpcore' ),
				'page'  => __( 'home', 'tpcore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home1.png', dirname(__FILE__) ),
				'preview_link' => 'https://themegenix.net/wp/nerko/',
			),
            'tp_demo_home2' => array(
				'title' => __( 'Home Two', 'tpcore' ),
				'page'  => __( 'home-02', 'tpcore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home2.png', dirname(__FILE__) ),
				'preview_link' => 'https://themegenix.net/wp/nerko/home-02/',
			),
            'tp_demo_home3' => array(
				'title' => __( 'Home Three', 'tpcore' ),
				'page'  => __( 'home-03', 'tpcore' ),
				'screenshot' => plugins_url( 'assets/img/demo/home3.png', dirname(__FILE__) ),
				'preview_link' => 'https://themegenix.net/wp/nerko/home-03/',
			),
		);
    ...
    public function ocdi_after_import_setup( $selected_file ) {
        ...
        update_option( 'nerko_ocdi_importer_flash', true );
    }

    private function assign_menu_to_location() {

        $main_menu = get_term_by( 'name', 'Main Menu', 'nav_menu' );
        $blog_menu = get_term_by( 'name', 'Blog Page Menu', 'nav_menu' );
    ...
    public function tp_ocdi_rewrite_flush() {
        ...
        if ( get_option( 'nerko_ocdi_importer_flash' ) == true ) {
            flush_rewrite_rules();
            delete_option( 'nerko_ocdi_importer_flash' );
        }
    }
}
