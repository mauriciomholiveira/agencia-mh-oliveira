...
class TG_CTA extends Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Let\'s start minting', 'tpcore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => tp_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__('Invest and manage all your NFTs at one place.', 'tpcore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Join community', 'tpcore'),
        ...
        // _cta_shape
        $this->start_controls_section(
            '_tg_cta_shape_section',
            [
                'label' => esc_html__('CTA Shapes', 'tpcore'),
            ]
        );
        ...
        $this->add_control(
            'tg_shape_image01',
            [
                'label' => esc_html__( 'Choose left top shape', 'tpcore' ),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' => \Elementor\Utils::get_placeholder_image_src(),
                ],
	...
	protected function render() {
		...
		<?php if ( $settings['tg_design_style']  == 'layout-2' ): ?>
            ...
            <!-- cta-area -->
            <section class="cta-area style-two">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8">
                            <div class="cta__content style-two text-center">

                                <?php if(!empty( $settings['tg_shapes_show'] )) : ?>

                                    <?php if(!empty( $tg_shape_image01 )) : ?>
                                    <img src="<?php echo esc_url($tg_shape_image01); ?>" width="24" alt="<?php echo esc_attr($tg_shape_alt01); ?>" style="top: 0%; left: -16%" data-anime="opacity:[0, 1]; scale:[0, 1]; onview: true; delay: 400;">
                                    <?php endif; ?>

                                    <?php if(!empty( $tg_shape_image02 )) : ?>
                                    <img src="<?php echo esc_url($tg_shape_image02); ?>" width="48" alt="<?php echo esc_attr($tg_shape_alt02); ?>" style="bottom: 16%; left: -8%" data-anime="opacity:[0, 1]; scale:[0, 1]; onview: true; delay: 440;">
                                    <?php endif; ?>

                                    <?php if(!empty( $tg_shape_image03 )) : ?>
                                    <img src="<?php echo esc_url($tg_shape_image03); ?>" width="40" alt="<?php echo esc_attr($tg_shape_alt03); ?>" style="top: 0%; right: -16%" data-anime="opacity:[0, 1]; scale:[0, 1]; onview: true; delay: 440;">
                                    <?php endif; ?>

                                    <?php if(!empty( $tg_shape_image04 )) : ?>
                                    <img src="<?php echo esc_url($tg_shape_image04); ?>" width="24" alt="<?php echo esc_attr($tg_shape_alt04); ?>" style="bottom: 16%; right: -8%" data-anime="opacity:[0, 1]; scale:[0, 1]; onview: true; delay: 420;">
                                    <?php endif; ?>
        ...
        <?php elseif ( $settings['tg_design_style']  == 'layout-3' ): ?>
            ...
            <!-- cta-area -->
            <section class="cta-area style-three">

                <?php if( !empty( $tg_bg_url ) ) : ?>
                    <div class="cta-bg" data-background="<?php echo esc_url( $tg_bg_url ); ?>"></div>
                <?php endif; ?>

                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8">
                            <div class="cta__content style-three text-center">

                                <?php if(!empty( $settings['tg_shapes_show']) ) : ?>

                                    <?php if(!empty( $tg_shape_image01 )) : ?>
                                    <img src="<?php echo esc_url($tg_shape_image01); ?>" width="24" alt="<?php echo esc_attr($tg_shape_alt01); ?>" style="top: 0%; left: -16%">
                                    <?php endif; ?>

                                    <?php if(!empty( $tg_shape_image02 )) : ?>
                                    <img src="<?php echo esc_url($tg_shape_image02); ?>" width="48" alt="<?php echo esc_attr($tg_shape_alt02); ?>" style="bottom: 16%; left: -8%">
                                    <?php endif; ?>

                                    <?php if(!empty( $tg_shape_image03 )) : ?>
                                    <img src="<?php echo esc_url($tg_shape_image03); ?>" width="40" alt="<?php echo esc_attr($tg_shape_alt03); ?>" style="top: 0%; right: -16%">
                                    <?php endif; ?>

                                    <?php if(!empty( $tg_shape_image04 )) : ?>
                                    <img src="<?php echo esc_url($tg_shape_image04); ?>" width="24" alt="<?php echo esc_attr($tg_shape_alt04); ?>" style="bottom: 16%; right: -8%">
                                    <?php endif; ?>
                                ...
                                <?php if(!empty( $settings['tg_button_show'] )) : ?>
                                    <a <?php echo $this->get_render_attribute_string( 'tg-button-arg' ); ?> >
                                        <?php echo $settings['tg_btn_text']; ?> <i class="unicon-arrow-up-right"></i>
                                    </a>
                                <?php endif; ?>
