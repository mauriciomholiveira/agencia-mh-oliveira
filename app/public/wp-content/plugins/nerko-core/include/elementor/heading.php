...
class TP_Heading extends Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Nerko Sub Title Here', 'tpcore'),
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => tp_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Nerko Title Here', 'tpcore'),
                'placeholder' => esc_html__('Type Heading Text', 'tpcore'),
                'label_block' => true,
            ]
        );
	...
	protected function render() {
        ...
        if ('2' == $settings['tp_btn_link_type']) {
            $this->add_render_attribute('tg-button-arg', 'href', get_permalink($settings['tp_btn_page_link']));
        	...
        	if ( ! empty( $settings['tp_btn_link']['url'] ) ) {
                $this->add_link_attributes( 'tg-button-arg', $settings['tp_btn_link'] );
                $this->add_render_attribute('tg-button-arg', 'class', 'btn');
            }
        }
		...
		<?php if ( $settings['tp_design_style']  == 'layout-2' ):
            ...
            $this->add_render_attribute('sub_title_args', 'class', 'sub-title tg-text-gradient');
        ?>

            <div class="section__title section__title-two">

                <?php
                    if ( !empty($settings['tp_sub_title']) ) :
                        printf( '<span %1$s>%2$s</span>',
                            $this->get_render_attribute_string( 'sub_title_args' ),
                            tp_kses( $settings['tp_sub_title' ] )
                        );
                    endif;
                ?>
                ...
                <?php if ( !empty($settings['tp_description']) ) : ?>
                    <p class="desc"><?php echo tp_kses( $settings['tp_description'] ); ?></p>
                <?php endif; ?>
