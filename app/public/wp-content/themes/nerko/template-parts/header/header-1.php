<?php
	...
	*/
    ...
    $nerko_heder_btn_text = get_theme_mod( 'nerko_heder_btn_text', __( 'Connect wallet', 'nerko' ) );
                ...
                <div class="col-12">
                    ...
                    <div class="tgmenu__wrap">
                        <nav class="tgmenu__nav">
                            ...
                            <?php if ( !empty($nerko_show_header_right) ) : ?>
                            <div class="tgmenu__action">
                                <ul class="list-wrap">

                                    <?php if ( !empty($nerko_show_header_social) ) : ?>
                                    ...
                                    <?php if ( !empty($nerko_show_heder_btn) ) : ?>
                                        <li class="header-btn"><button class="btn border-btn" data-bs-toggle="modal" data-bs-target="#connectModal"><?php echo esc_html($nerko_heder_btn_text); ?></button></li>
                                    <?php endif; ?>
